...
export const sendVerificationEmail = async (userId: string, variables: Record<string, string>,emailId:string) => {
    ...
    const data = {"userId": userId, emailId, "senderAddress": process.env.DEFAULT_SENDER_ADDRESS ?? "info@klinikermed.com", "isEmailTracked": false , ...variables};
